...
const Dashboard = lazy(
  () => import("@modules/helpdesk/pages/dashboard/Dashboard"),
);
const TicketList = lazy(
  () => import("@modules/helpdesk/pages/tickets/TicketList"),
);
const NewTicket = lazy(
  () => import("@modules/helpdesk/pages/tickets/NewTicket"),
);
const TicketDetail = lazy(
  () => import("@modules/helpdesk/pages/tickets/TicketDetail"),
);
const TicketCrud = lazy(
  () => import("@modules/helpdesk/pages/tickets/TicketCrud"),
);
const TicketBoard = lazy(
  () => import("@modules/helpdesk/pages/tickets/TicketBoard"),
);
const TicketTemplates = lazy(
  () => import("@modules/helpdesk/pages/tickets/TicketTemplates"),
);
const Requests = lazy(() => import("@modules/helpdesk/pages/tickets/Requests"));
const AssignmentRouting = lazy(
  () => import("@modules/helpdesk/pages/tickets/AssignmentRouting"),
);
const Incidents = lazy(
  () => import("@modules/helpdesk/pages/incidents/Incidents"),
);
const IncidentCrud = lazy(
  () => import("@modules/helpdesk/pages/incidents/IncidentCrud"),
);
const MajorIncidents = lazy(
  () => import("@modules/helpdesk/pages/incidents/MajorIncidents"),
);
const Escalations = lazy(
  () => import("@modules/helpdesk/pages/incidents/Escalations"),
);
const SlaMonitor = lazy(
  () => import("@modules/helpdesk/pages/incidents/SlaMonitor"),
);
const OutageTracking = lazy(
  () => import("@modules/helpdesk/pages/incidents/OutageTracking"),
);
const WarRoom = lazy(() => import("@modules/helpdesk/pages/incidents/WarRoom"));
const IncidentDiagnosis = lazy(
  () => import("@modules/helpdesk/pages/incidents/IncidentDiagnosis"),
);
const IncidentPlaybooks = lazy(
  () => import("@modules/helpdesk/pages/incidents/IncidentPlaybooks"),
);
const PostImplReviews = lazy(
  () => import("@modules/helpdesk/pages/incidents/PostImplReviews"),
);
const PriorityMatrixEditor = lazy(
  () => import("@modules/helpdesk/pages/incidents/PriorityMatrixEditor"),
);
const AuditTrail = lazy(
  () => import("@modules/helpdesk/pages/incidents/AuditTrail"),
);
const Alerts = lazy(() => import("@modules/helpdesk/pages/incidents/Alerts"));
const IncidentRecord = lazy(
  () => import("@modules/helpdesk/pages/incidents/IncidentRecord"),
);
const IncidentTriage = lazy(
  () => import("@modules/helpdesk/pages/incidents/IncidentTriage"),
);
const IncidentCIRelated = lazy(
  () => import("@modules/helpdesk/pages/incidents/IncidentCIRelated"),
);
const IncidentRelatedIncidents = lazy(
  () => import("@modules/helpdesk/pages/incidents/IncidentRelatedIncidents"),
);
const SlaTimeline = lazy(
  () => import("@modules/helpdesk/pages/incidents/SlaTimeline"),
);
const IncidentDashboard = lazy(
  () => import("@modules/helpdesk/pages/incidents/IncidentDashboard"),
);
const Problems = lazy(
  () => import("@modules/helpdesk/pages/problems/Problems"),
);
const ProblemCrud = lazy(
  () => import("@modules/helpdesk/pages/problems/ProblemCrud"),
);
const ProblemRecord = lazy(
  () => import("@modules/helpdesk/pages/problems/ProblemRecord"),
);
const ProblemDashboard = lazy(
  () => import("@modules/helpdesk/pages/problems/ProblemDashboard"),
);
const Changes = lazy(() => import("@modules/helpdesk/pages/changes/Changes"));
const ChangeCrud = lazy(
  () => import("@modules/helpdesk/pages/changes/ChangeCrud"),
);
const ChangeCalendarPage = lazy(
  () => import("@modules/helpdesk/pages/changes/ChangeCalendarPage"),
);
const ChangeRecord = lazy(
  () => import("@modules/helpdesk/pages/changes/ChangeRecord"),
);
const ChangeDashboard = lazy(
  () => import("@modules/helpdesk/pages/changes/ChangeDashboard"),
);
const RequestRecord = lazy(
  () => import("@modules/helpdesk/pages/requests/RequestRecord"),
);
const RequestDashboard = lazy(
  () => import("@modules/helpdesk/pages/requests/RequestDashboard"),
);
const CatalogBrowser = lazy(
  () => import("@modules/helpdesk/pages/requests/CatalogBrowser"),
);
const KnowledgeDashboard = lazy(
  () => import("@modules/helpdesk/pages/knowledge/KnowledgeDashboard"),
);
const ArticleRecord = lazy(
  () => import("@modules/helpdesk/pages/knowledge/ArticleRecord"),
);
const KnowledgeBase = lazy(
  () => import("@modules/helpdesk/pages/dashboard/KnowledgeBase"),
);
const KnowledgeInsights = lazy(
  () => import("@modules/helpdesk/pages/dashboard/KnowledgeInsights"),
);
const NeuralSearch = lazy(
  () => import("@modules/helpdesk/pages/knowledge/NeuralSearch"),
);
const SlaDashboard = lazy(
  () => import("@modules/helpdesk/pages/slm/SlaDashboard"),
);
const AssignmentDashboard = lazy(
  () => import("@modules/helpdesk/pages/assignments/AssignmentDashboard"),
);
const ApprovalDashboard = lazy(
  () => import("@modules/helpdesk/pages/approvals/ApprovalDashboard"),
);
const WalkupDashboard = lazy(
  () => import("@modules/helpdesk/pages/walkup/WalkupDashboard"),
);
...
const OnCallSchedules = lazy(
  () => import("@modules/helpdesk/pages/support/OnCallSchedules"),
);
const ShiftHandover = lazy(
  () => import("@modules/helpdesk/pages/support/ShiftHandover"),
);
const SupportEmail = lazy(
  () => import("@modules/helpdesk/pages/support/SupportEmail"),
);
const OpsWorkspace = lazy(
  () => import("@modules/helpdesk/pages/support/OpsWorkspace"),
);
...
const AssetDetail = lazy(
  () => import("@modules/helpdesk/pages/assets/AssetDetail"),
);
const HelpdeskReports = lazy(
  () => import("@modules/helpdesk/pages/reports/HelpdeskReports"),
);
const CsatDashboard = lazy(
  () => import("@modules/helpdesk/pages/reports/CsatDashboard"),
);
const KnownErrors = lazy(
  () => import("@modules/helpdesk/pages/reports/KnownErrors"),
);
const HelpdeskAdmin = lazy(
  () => import("@modules/helpdesk/pages/admin/HelpdeskAdmin"),
);
const CMDBImpact = lazy(
  () => import("@modules/helpdesk/pages/misc/CMDBImpact"),
);
      ...
      <Routes>
        ...
        >
          ...
          <Route
            ...
            element={
              <ModuleGuard module="helpdesk">
                <IncidentRelatedIncidents />
              </ModuleGuard>
            }
          />
          <Route
            path="incidents/:id/sla"
            element={
              <ModuleGuard module="helpdesk">
                <SlaTimeline />
              </ModuleGuard>
          ...
          {/* Helpdesk CMDB / Service Portfolio */}
          <Route
            path="cmdb-dashboard"
            element={
              <ModuleGuard module="helpdesk">
