...
const allNavItems: NavItem[] = [
  ...
  {
    label: "Software Policy",
    path: "/prohibited-software",
    icon: AlertTriangle,
    module: "itam",
  },
  {
...
const platformNavItems: NavItem[] = [
  {
    ...
    path: "/superadmin",
    icon: Shield,
    permission: "platform.view_dashboard",
    section: "Platform",
  },
  {
    ...
    icon: Building2,
    permission: "platform.view_tenants",
  },
  {
    label: "Plans & Pricing",
    path: "/superadmin/plans",
    icon: CreditCard,
    permission: "platform.view_plans",
  },
  {
    label: "New Tenant",
  ...
  },
  {
    ...
    icon: Layers,
    permission: "platform.view_modules",
    section: "Operations",
  },
  {
    ...
    icon: Activity,
    permission: "platform.view_operations",
  },
  {
    label: "Platform SLA",
    path: "/superadmin/sla",
    icon: Clock,
    permission: "saas.sla.read",
  },
  {
    label: "Audit Logs",
    path: "/superadmin/audit",
    icon: FileText,
    permission: "platform.view_audit",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    permission: "platform.view_security",
  },
  {
    label: "Platform Operators",
    path: "/superadmin/admins",
    icon: Users,
    permission: "platform.view_superadmins",
  ...
  },
  {
    ...
    icon: Settings,
    permission: "platform.view_platform",
  },
  {
    label: "Control Plane",
...
export default function Layout() {
  ...
  const privilegedSession = (() => {
    try {
      return JSON.parse(localStorage.getItem("privilegedSession") || "null");
    } catch {
      return null;
    }
  })();
      ...
      <main className="flex-1 overflow-y-auto">
        {privilegedSession && (
          <div className="sticky top-0 z-50 flex items-center justify-between bg-amber-500 px-4 py-2 text-sm font-semibold text-amber-950 shadow">
            <span>
              Privileged session: acting in {privilegedSession.tenantName} ·{" "}
              {privilegedSession.reason} · expires{" "}
              {new Date(privilegedSession.expiresAt).toLocaleTimeString()}
            </span>
            <button
              onClick={exitPrivilegedSession}
              className="rounded bg-amber-950 px-3 py-1 text-white"
            >
              Exit session
            </button>
          </div>
