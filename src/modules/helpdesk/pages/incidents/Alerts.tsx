              ...
              alerts.map((a) => (
                <tr key={a._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`px-2 py-1 text-xs font-medium rounded-full ${SEVERITY_COLORS[a.severity] || "bg-gray-100 text-gray-700"}`}
                    >
                      {a.severity}
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    <span
                      className={`px-2 py-1 text-xs font-medium rounded-full ${STATUS_COLORS[a.status] || "bg-gray-100 text-gray-700"}`}
                    >
                      {a.status}
                    </span>
                  </td>
                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      {a.status !== "resolved" && (
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-green-700 bg-green-50 rounded hover:bg-green-100 transition"
                        >
