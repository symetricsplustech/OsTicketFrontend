...
export default function AssetDetail() {
  ...
  if (!asset)
    return (
      <div className="text-center py-12 text-gray-500">Asset not found</div>
    );
          ...
          <div className="card p-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span
                  className={`px-2 py-1 text-xs rounded-full ${asset.status === "deployed" ? "bg-green-100 text-green-700" : asset.status === "in_stock" ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-700"}`}
                >
                  {asset.status}
                </span>
              </div>
