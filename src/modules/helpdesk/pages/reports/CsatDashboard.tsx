      ...
      <div>
        <div>
          ...
          <p className="text-sm text-gray-500">
            Surveys, negative-feedback recovery &amp; scores
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl border p-5">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Negative-feedback follow-up will use the shared task workflow.
          </p>
        </div>
      </div>
      ...
      <div className="card p-5">
        ...
        {surveys.length === 0 ? (
          <p className="text-xs text-gray-400">
            No responses loaded. Low scores (≤ 2) trigger follow-up tasks via
            the recovery sweep.
          </p>
        ) : (
