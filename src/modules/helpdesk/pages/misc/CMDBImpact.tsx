...
function CMDBImpactPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {health && (
        <div
          className={`card p-6 border-2 ${healthScoreBg(health.healthScore)}`}
        >
          ...
          <div className="grid grid-cols-5 gap-4">
            ...
            <div className="text-center">
              <p
                className={`text-3xl font-bold ${healthScoreColor(health.healthScore)}`}
              >
                {health.healthScore}
              </p>
        ...
        <div className="card overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold">
              Impacted CIs: {results.totalImpacted}
            </h2>
          </div>
                ...
                results.impactedCIs.map((ci) => (
                  <tr key={ci._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 text-xs font-medium rounded-full ${CRITICALITY_COLORS[ci.criticality] || "bg-gray-100 text-gray-700"}`}
                      >
                        {ci.criticality}
                      </span>
                    </td>
