...
export default function KnowledgeDashboard() {
  ...
  const loadDashboard = async () => {
    setLoading(true);
    try {
      const res = await knowledgeApi.getDashboard();
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={() => navigate("/knowledge-insights")}>
            KB Insights
          </Button>
        </div>
      </div>
              ...
              >
                <div>
                  <p className="text-sm">
                    ...
                    rated as{" "}
                    <Badge
                      className={`ml-1 ${f.type === "helpful" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
                    >
                      {f.type.replace(/_/g, " ")}
                    </Badge>
                  </p>
