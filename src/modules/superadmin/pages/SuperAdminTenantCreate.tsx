      ...
      >
        ...
        <div className="border-t pt-5">
          ...
          <p className="text-xs text-gray-500 mb-3">
            Select which modules this tenant will have access to. You can change
            this later.
          </p>
          <div className="grid grid-cols-2 gap-2">
            {ALL_MODULES.map((m) => (
              <label
                key={m.key}
                className={`flex items-center gap-2 px-3 py-2 rounded-lg border text-sm cursor-pointer transition-colors ${selectedModules.includes(m.key) ? "bg-brand-50 border-brand-300 text-brand-700" : "hover:bg-gray-50 text-gray-600"}`}
              >
                <input
                  type="checkbox"
