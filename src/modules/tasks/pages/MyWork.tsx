  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-gray-500">{total} task{total !== 1 ? 's' : ''} assigned to you</div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <select value={stateFilter} onChange={(e) => { setStateFilter(e.target.value); setPage(1); }} className="px-3 py-2 border border-gray-300 rounded-lg text-sm">
          ...
          {['new', 'open', 'in_progress', 'pending_customer', 'pending_approval', 'on_hold', 'resolved', 'closed'].map((s) => (
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-400">No tasks assigned to you</div>
      ) : (
