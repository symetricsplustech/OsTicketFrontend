  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-gray-500">{total} task{total !== 1 ? 's' : ''} in group queues</div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-400">No tasks in group queues</div>
      ) : (
