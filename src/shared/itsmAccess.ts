...
export const ITSM_ROUTE_ACCESS: readonly ItsmRouteAccess[] = [
  ...
  { prefix: '/knowledge-dashboard', module: 6, permissions: ['itsm.knowledge.kb_read', 'itsm.knowledge.ui.kb_dashboard.access'] },
  { prefix: '/knowledge-insights', module: 6, permissions: ['itsm.knowledge.article_read', 'itsm.knowledge.ui.article_metrics.access'] },
  ...
  { prefix: '/ritms', module: 5, permissions: ['itsm.request_catalog.ritm_read', 'itsm.request_catalog.ui.ritm_record.access'] },
  { prefix: '/requests', module: 5, permissions: ['itsm.request_catalog.request_read', 'itsm.request_catalog.ui.request_record.access'] },
  { prefix: '/catalog', module: 5, permissions: ['itsm.request_catalog.catalog_item.read', 'itsm.request_catalog.ui.catalog_browser.access'] },
  ...
  { prefix: '/incident-dashboard', module: 2, permissions: ['itsm.incident.incident.read', 'itsm.incident.ui.incident_dashboard.access'] },
  ...
  { prefix: '/playbooks', module: 2, permissions: ['itsm.incident.incident.read', 'itsm.incident.ui.incident_workspace.access'] },
  { prefix: '/priority-matrix', module: 2, permissions: ['itsm.incident.incident.read', 'itsm.incident.ui.priority_matrix_admin.access'] },
  { prefix: '/tasks', module: 1, permissions: ['itsm.core.task.read', 'itsm.core.ui.task_list.access'] },
  { prefix: '/tickets', module: 1, permissions: ['itsm.core.task.read', 'itsm.incident.incident.read'] },
  { prefix: '/ticket-board', module: 1, permissions: ['itsm.core.task_read', 'itsm.core.ui.task_list.access'] },
