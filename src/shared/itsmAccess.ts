...
export const ITSM_ROUTE_ACCESS: readonly ItsmRouteAccess[] = [
  ...
  },
  {
    prefix: "/sla-monitor",
    module: 7,
    permissions: ["itsm.sla.task_sla_read", "itsm.sla.ui.sla_timer.access"],
  },
  {
    prefix: "/knowledge-dashboard",
    module: 6,
    permissions: [
  ...
  },
  {
    prefix: "/tickets",
    module: 1,
    permissions: ["itsm.core.task.read", "itsm.incident.incident.read"],
  },
  {
    prefix: "/ticket-board",
    module: 1,
    permissions: ["itsm.core.task_read", "itsm.core.ui.my_work.access"],
  },
  {
    prefix: "/audit-trail",
    module: 1,
    permissions: ["itsm.core.audit_event.read", "itsm.core.audit_read"],
  },
];

export function getItsmRouteAccess(
  pathname: string,
): ItsmRouteAccess | undefined {
  return ITSM_ROUTE_ACCESS.find(
